...
struct copy_opt_t {
	...
	/** Function pointer used to check requirements for compressing instructions */
...
/**
 * The kind of affinity an edge describes.
 */
typedef enum aff_edge_type_t {
	aff_edge_unknown,

	aff_edge_noncopy,
	aff_edge_compression,
} aff_edge_type_t;
...
struct neighb_t {
	...
	/**
	 * The type of affinity this edge describes.
	 *
